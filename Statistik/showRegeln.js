...
function showRegeln() {
    ...
    if (LS.ME === '3425' || LS.ME === '37 18') {
        ...
        html = '<div class="J">'
                ...
                + '<li>Am Ende jeder Runde erhalten die Gewinnerinnen von den Verlierern jeweils 10 Cent pro Punkt.</li>'
                + '</ul>'
                ...
                + '<li><span style="font-weight: bold">Prämienzwang:</span>&nbsp;&nbsp;Nur wenn es der Farbzwang erzwingt darf ein angesagtes Vogerl oder der angesagte König ultimo aufgegeben werden.</li>'
