...
function getTurnierkalender() {
    ...
    if (I === 50) {
        html += '<br><div class="ui-grid-b M">'
                + '<div class="ui-block-a" style="width:20%"></div>'
                + '<div class="ui-block-b" style="width:40%">Gesamtwertung</div>'
                + '<div class="ui-block-c" style="width:40%">Tageswertung</div>'
                + '</div><br>';
        html += '<div class="ui-grid-b S2">'
                + '<div class="ui-block-a" style="width:20%;padding-top:.2em">2018</div>'
                ...
                + '<div class="ui-block-a" style="width:20%;padding-top:.2em">2017</div>'
                + '<div class="ui-block-b" style="width:40%">'
                ...
                + '</div><br>'
                + '<div class="ui-grid-b S2">'
                + '<div class="ui-block-a" style="width:20%;padding-top:.2em">2016</div>'
                + '<div class="ui-block-b" style="width:40%">'
                + '<span>1. <b>Mülleder Josef</b>, Wien</span><br>'
                ...
                + '</div><br>'
                + '<div class="ui-grid-b S2">'
                + '<div class="ui-block-a" style="width:20%;padding-top:.2em">2015</div>'
                + '<div class="ui-block-b" style="width:40%">'
                ...
                + '</div><br>'
                + '<div class="ui-grid-b S2">'
                + '<div class="ui-block-a" style="width:20%;padding-top:.2em">2014</div>'
                + '<div class="ui-block-b" style="width:40%">'
                ...
                + '</div><br>'
                + '<div class="ui-grid-b S2">'
                + '<div class="ui-block-a" style="width:20%;padding-top:.2em">2013</div>'
                + '<div class="ui-block-b" style="width:40%">'
                ...
                + '</div><br>'
                + '<div class="ui-grid-b S2">'
                + '<div class="ui-block-a" style="width:20%;padding-top:.2em">2012</div>'
                + '<div class="ui-block-b" style="width:40%">'
                ...
                + '</div><br>'
                + '<div class="ui-grid-b S2">'
                + '<div class="ui-block-a" style="width:20%;padding-top:.2em">2011</div>'
                + '<div class="ui-block-b" style="width:40%">'
                ...
                + '</div><br>'
                + '<div class="ui-grid-b S2">'
                + '<div class="ui-block-a" style="width:20%;padding-top:.2em">2010</div>'
                + '<div class="ui-block-b" style="width:40%">'
                ...
                + '</div><br>'
                + '<div class="ui-grid-b S2">'
                + '<div class="ui-block-a" style="width:20%;padding-top:.2em">2009</div>'
                + '<div class="ui-block-b" style="width:40%">'
                ...
                + '</div><br>'
                + '<div class="ui-grid-b S2">'
                + '<div class="ui-block-a" style="width:20%;padding-top:.2em">2008</div>'
                + '<div class="ui-block-b" style="width:40%">'
