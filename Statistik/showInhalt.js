...
//    }
    ...
    if (stCup === 49 || stCup === 51 || stCup === 52) {
        ...
        $('#sideTurniere').html(
                '<li data-role="list-divider">&nbsp;&nbsp;&nbsp;&nbsp;Statistiken</li>'
                + '<li data-icon="false"><a id=bCupwertung onclick="showCupwertung();">&nbsp;Gesamtwertung</a></li>'
                + '<li data-icon="false"><a id=bHeinewertung onclick="showHeinewertung();">&nbsp;Heinewertung</a></li>'
                + '<li data-icon="false"><a id="bBestenliste" onClick="showBestenliste();" ' + (LS.VIP ? '' : 'class="ui-disabled"') + '>&nbsp;Ewige Bestenliste</a></li>'
                + '<li data-icon="false"><a id=bPlatzierungen onclick="showPlatzierungen();">&nbsp;Platzierungen</a></li>'
                + '<li data-icon="false"><a id="bTeilnehmerzahlen" onClick="showTeilnehmerzahlen();" ' + (LS.VIP ? '' : 'class="ui-disabled"') + '>&nbsp;Teilnehmerzahlen</a></li>'
                + (QUERFORMAT()
                        ? '<li data-icon="foto"><a id=bChronik onclick="showChronik(1)">&nbsp;Chronik</a><a id="bParallaxCh" onclick="showParallax(true);"></a></li>'
                        : '')
                + '<li data-role="list-divider">&nbsp;&nbsp;&nbsp;&nbsp;Allgemeines</li>'
                + (CUPS.MELDAKT[stCup]
                        ? '<li data-icon="false"><a id="bAktuelles" onClick="showAktuelles();">&nbsp;Aktuelles</a></li>'
