...
function showGesamt(pSort) {

    if (pSort) {
        showEinenMoment(CUPS.NAME[stCup], 'Die&nbsp;Gesamtübersicht&nbsp;wird&nbsp;sortiert.');
    } else {
        pSort = 'N123';
        showEinenMoment(CUPS.NAME[stCup], 'Die&nbsp;Gesamtübersicht&nbsp;wird&nbsp;erstellt.');
    }
