...
function showRegeln() {
    ...
    if (LS.ME === '3425') {
        ...
        html = '<div class="J">'
                ...
                + '<div class="ui-responsive S" style="padding: ' + hTextPadding + '">'

                + '<ul>'
                + '<div class="M B" style="padding: 1vh 0 1vh 0">§&nbsp;&nbsp;Lizitation:</div>'
                + '<li><span style="font-weight: bold">Vorhand:</span>&nbsp;&nbsp;Die Vorhand eröffnet mit "Mein Spiel!" oder mit "Vorhand!" die Lizitation. Will sie einen Sechserdreier spielen, muss sie diesen sofort lizitieren. "Sechserdreier!" oder "Mein Spiel!" bzw. "Vorhand!" Der Vorhandspieler darf zu Beginn nicht "Weiter!" sagen und darf nicht ein anderes Spiel halten.</li>'
                + '<li><span style="font-weight: bold">Überbieten / Weiter:</span>&nbsp;&nbsp;Danach können die Spieler ebenfalls ein (höherrangiges) Spiel lizitieren oder "Weiter!" sagen.</li>'
                ...
                + '<li><span style="font-weight: bold">Ausspiel:</span>&nbsp;&nbsp;Beim Trischacken hat immer die Vorhand das erste Ausspielen. Bei allen anderen Negativspielen spielt jeweils der Spielersteher aus.</li>'
                + '<li><span style="font-weight: bold">Stichzwang:</span>&nbsp;&nbsp;Es gilt Stichzwang.</li>'
                + '<li><span style="font-weight: bold">Farbzwang:</span>&nbsp;&nbsp;Kann ein Spieler eine Farbe nicht bedienen, muss er Tarock zugeben. Erst wenn ein Spieler kein Tarock mehr im Blatt hat, darf er eine beliebige Farbkarte zugeben.</li>'
                + '<li><span style="font-weight: bold">Ausnahmen:</span>&nbsp;&nbsp;Der Pagat darf jeweils nur als letztes Tarock ausgespielt und zugegeben werden. Bei Negativspielen gibt es keinen Kaiserstich.</li>'
                ...
                + '<li>Wenn kein Verstoß gegen Farbzwang oder Stichzwang vorliegt, darf die gespielte Karte nicht zurückgenommen werden.</li>'
