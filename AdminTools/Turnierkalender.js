    ...
    if (pTermin >= 0) {
        ...
        if (TERMINE[I].VERANSTALTER === "Präsidium") {
            ...
            if (TERMINE[pTermin].CUP === 56) {
                $('#tVERANSTALTER').html('Präsidium, Tel. 0676 3404100, 0676 3467401, 0664 3987990');
            } else {
...
//            $('#tCUP').html('<span class="S">(50 = Hausruckcup, 16 = Tarock on Tour, 49 = Österreichfinale)</span>').removeClass('B');
            $('#tCUP').html('<span class="S">(50 = Hausruckcup, 49 = Österreichfinale)</span>').removeClass('B');
        } else if (LS.ME === '4506') { // Sepp Lang
            $('#iCUP').val('');
            $('#tCUP').html('<span class="S">(53 = Sauwaldcup, 34 = Sauwalder MT)</span>').removeClass('B');
        }
...
//        }
        if (hCUP !== 49 && hCUP !== 50) {
            showEinenTip('#iCUP', 'Hausruckcup = 50,<br>Österreichfinale = 49!');
            return;
        }
    } else if (LS.ME === '4506') { // Sepp Lang
        if (hCUP !== 53 && hCUP !== 34) {
            showEinenTip('#iCUP', 'Sauwaldcup = 53,<br>Sauwalder MT = 34!');
            return;
        }
    }
