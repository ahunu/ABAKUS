...
// 39 erledidigt
// 40
function writeCanvas(pStatusListe) {
    $('#tStand').hide();
    $('.hfHeaderZeile1,#qfHeaderZeile1').html('Risk Assessment - Management On Site');

    if (pStatusListe === 19) {
        $('.hfHeaderZeile2,#qfHeaderZeile2').html('Statusliste: Erfasst');
    } else if (pStatusListe === 25) {
        $('.hfHeaderZeile2,#qfHeaderZeile2').html('Statusliste: Nicht genehmigt');
    } else if (pStatusListe === 29) {
        $('.hfHeaderZeile2,#qfHeaderZeile2').html('Statusliste: Genehmigt');
    } else if (pStatusListe === 30) {
        $('.hfHeaderZeile2,#qfHeaderZeile2').html('Statusliste: In arbeit');
    } else if (pStatusListe === 35) {
        $('.hfHeaderZeile2,#qfHeaderZeile2').html('Statusliste: Abgebrochen');
    } else if (pStatusListe === 39) {
        $('.hfHeaderZeile2,#qfHeaderZeile2').html('Statusliste: Erledigt');
    } else if (pStatusListe === 40) {
        $('.hfHeaderZeile2,#qfHeaderZeile2').html('Statusliste: Geprüft');
    } else if (pStatusListe === 40) {
        $('.hfHeaderZeile2,#qfHeaderZeile2').html('Statusliste: Beanstandet');
    }

    if (PC) {
     document.title = 'RAMOS';
    }
}
