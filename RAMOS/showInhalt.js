...
function showLogo() {
    ...
    $('#dRumpf').html("<div onclick='showLogo();' style='height:" + hH + 'px; width:' + hW + 'px; background-image: url("../Icons/LAFARGE.png"); background-size: 50%; background-position: center; background-repeat: no-repeat;\'></div>').show();

    var hZitat = getZitat();
    $('#tWeisheit').html(hZitat[0]);
    $('#tWeiser').html(hZitat[1]);

    $('#tWeisheit').html('Gemeinsam sind wir stark.');
    $('#tWeiser').html('Henry La Farge, 1829-1904, fr. Firmengründer');
