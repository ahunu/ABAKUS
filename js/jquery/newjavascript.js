...
<body class="scrollable-block">
	<div class="header">
		<h1>
			Demo: Using StickyTableHeaders within a scrollable block
			<button type="button" class="destroy">Destroy on first table</button>
    ...
    <div class="scrollable-area">
        ...
        <div class="row">
            <div class="cell s1of2 first">
                <h3>
                    Men Elite Championnats du Monde UCI (DEN/CM)
                </h3>
                <table class="uci">
                    <thead>
                        <tr>
